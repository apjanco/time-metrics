...
def main():
    ...
    empire_threshold = st.sidebar.slider('empire threshold',value=0.8, min_value=0.0, max_value=1.0)
    soviet_threshold = st.sidebar.slider('soviet threshold',value=0.8, min_value=0.0, max_value=1.0)
    post_threshold = st.sidebar.slider('post threshold',value=0.8, min_value=0.0, max_value=1.0)
